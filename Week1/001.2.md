...
As you probably guessed, the application route is the parent of all your ember routes. You'll notice that we did not have to go to a URL other than root to view our application template. Since we didn't manually create an application route, Ember will provide an application route instance for us.
