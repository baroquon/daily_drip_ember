...
One final point about Ember components: any state you store on your component is ephemeral. If you navigate away from your component, or your component is destroyed all internal state will be lost. There are various strategies for preserving this state, but I would suggest that, in most cases, if the state needs to be preserved, it should probably exist outside of the component.
